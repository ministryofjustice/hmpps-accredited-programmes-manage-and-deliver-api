 ...
 *
 * @property id The unique identifier for the office. This is the business key and primary identifier.
 ...
 * @property regionId The foreign key reference to the region (redundant but included for data integrity)
