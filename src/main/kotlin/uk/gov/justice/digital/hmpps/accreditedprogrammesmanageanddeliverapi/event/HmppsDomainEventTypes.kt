...
enum class HmppsDomainEventTypes(val value: String) {
  ...
  INTERVENTIONS_SESSION_FEEDBACK_SUBMITTED("intervention.session-appointment.session-feedback-submitted"),
  ...
  PROBATION_CASE_SENTENCE_DELETED("probation-case.sentence.deleted"),
