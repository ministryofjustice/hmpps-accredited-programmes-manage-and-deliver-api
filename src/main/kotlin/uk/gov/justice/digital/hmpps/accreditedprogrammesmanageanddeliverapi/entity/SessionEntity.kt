...
fun SessionEntity.primaryFacilitator(): FacilitatorEntity {
  val byName = compareBy<SessionFacilitatorEntity>({ it.facilitator.personName }, { it.facilitatorCode })
  val sessionFacilitator =
