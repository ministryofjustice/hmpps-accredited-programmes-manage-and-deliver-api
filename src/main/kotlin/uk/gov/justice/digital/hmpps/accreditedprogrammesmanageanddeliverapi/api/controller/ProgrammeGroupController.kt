...
class ProgrammeGroupController(
  ...
  fun getGroupDetails(@PathVariable groupId: UUID): ResponseEntity<GroupDetailsResponse>? {
    return ResponseEntity.ok(programmeGroupService.getGroupDetails(groupId))
  }
