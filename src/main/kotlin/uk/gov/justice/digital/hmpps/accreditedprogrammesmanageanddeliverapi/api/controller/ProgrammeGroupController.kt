...
class ProgrammeGroupController(
  ...
  fun scheduleSession(
    ...
    val successMessage = scheduleService.scheduleIndividualSessionAndReturnResponse(groupId, scheduleSessionRequest)
  ...
  @Operation(
    tags = ["Programme Group controller"],
    summary = "bff endpoint to retrieve the edit cohort details for a programme group",
    operationId = "getBffEditGroupCohort",
    ...
    [
      ApiResponse(
        ...
        content = [
          Content(
            mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = Schema(implementation = EditGroupCohort::class),
          ),
        ],
      ),
      ApiResponse(
  ...
  @Operation(
    ...
    operationId = "getBffEditGroupGender",
    ...
    [
      ApiResponse(
        ...
        content = [
          Content(
            mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = Schema(implementation = EditGroupGender::class),
          ),
        ],
      ),
      ApiResponse(
  ...
  @GetMapping(
    "/bff/group/{groupId}/edit-gender",
    produces = [MediaType.APPLICATION_JSON_VALUE],
  )
  fun getBffEditGroupGender(@PathVariable groupId: UUID): ResponseEntity<EditGroupGender> = ResponseEntity.ok(programmeGroupService.getEditGenderForGroup(groupId))
