...
(
    ...
    sentence_end_date TIMESTAMP NOT NULL,
    pss_end_date      TIMESTAMP NULL,
...
COMMENT ON COLUMN referral_caselist_item.id IS 'The unique ID of the referral case list item.';
