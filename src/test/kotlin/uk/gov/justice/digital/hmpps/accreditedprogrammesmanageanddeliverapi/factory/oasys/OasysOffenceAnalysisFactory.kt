...
class OasysOffenceAnalysisFactory {
  ...
  private var recognisesImpact: String? = "No"
  private var numberOfOthersInvolved: String? = "2"
  private var othersInvolved: String? = "Yes"
  private var peerGroupInfluences: String? = "No"
  ...
  private var acceptsResponsibilityYesNo: String? = "Yes"
  private var acceptsResponsibility: String? = "OPD Automatic screen in as first test"
