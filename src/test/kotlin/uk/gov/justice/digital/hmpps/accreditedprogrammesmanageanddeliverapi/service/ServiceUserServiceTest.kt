...
class ServiceUserServiceTest {
  ...
  @Test
  fun `hasAccessToLimitedAccessOffenders should return only CRNs the user has access to`() {
    val username = "jsmith"
    ...
    val result = service.hasAccessToLimitedAccessOffenders(username, identifiers)
