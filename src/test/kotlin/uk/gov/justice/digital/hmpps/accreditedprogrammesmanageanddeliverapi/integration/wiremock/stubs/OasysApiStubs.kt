...
class OasysApiStubs(
  ...
  fun stubSuccessfulOasysAttitudeResponse(
    assessmentId: Long,
    oasysAttitude: OasysAttitude = OasysAttitudeFactory().produce(),
  ) {
    wiremock.stubFor(
      get(urlEqualTo("/assessments/$assessmentId/section/section12"))
        .willReturn(
          aResponse()
            .withStatus(200)
            .withHeader("Content-Type", "application/json")
            .withBody(objectMapper.writeValueAsString(oasysAttitude)),
        ),
    )
  }

  fun stubNotFoundOasysAttitudeResponse(assessmentId: Long) {
    wiremock.stubFor(
      get(urlEqualTo("/assessments/$assessmentId/section/section12"))
        .willReturn(
          aResponse()
      ...
      get(urlEqualTo("/assessments/$assessmentId/section/section8"))
        .willReturn(
          aResponse()
            .withStatus(200)
            .withHeader("Content-Type", "application/json")
            .withBody(objectMapper.writeValueAsString(oasysDrugDetail)),
        ),
    )
  }
  ...
  fun stubSuccessfulOasysEmotionalWellbeingResponse(
    assessmentId: Long,
    oasysEmotionalWellbeing: OasysEmotionalWellbeing = OasysEmotionalWellbeingFactory().produce(),
  ) {
    wiremock.stubFor(
      get(urlEqualTo("/assessments/$assessmentId/section/section10"))
        .willReturn(
          aResponse()
            .withStatus(200)
            .withHeader("Content-Type", "application/json")
            .withBody(objectMapper.writeValueAsString(oasysEmotionalWellbeing)),
        ),
    )
  }

  fun stubNotFoundOasysEmotionalWellbeingResponse(
    assessmentId: Long,
  ) {
    wiremock.stubFor(
      get(urlEqualTo("/assessments/$assessmentId/section/section10"))
  ...
  fun stubSuccessfulOasysThinkingAndBehaviourResponse(
    assessmentId: Long,
    oasysThinkingAndBehaviour: OasysThinkingAndBehaviour = OasysThinkingAndBehaviourFactory().produce(),
  ) {
    wiremock.stubFor(
      get(urlEqualTo("/assessments/$assessmentId/section/section11"))
        .willReturn(
          aResponse()
            .withStatus(200)
            .withHeader("Content-Type", "application/json")
            .withBody(objectMapper.writeValueAsString(oasysThinkingAndBehaviour)),
        ),
    )
  }

  fun stubNotFoundOasysThinkingAndBehaviourResponse(
    assessmentId: Long,
  ) {
    wiremock.stubFor(
      get(urlEqualTo("/assessments/$assessmentId/section/section11"))
