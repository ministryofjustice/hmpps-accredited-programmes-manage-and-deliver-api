...
| [`APG-2580-followup-2-sar-set-footgun-guardrails.md`](./APG-2580-followup-2-sar-set-footgun-guardrails.md) | Low priority — architecture test + optional mustache helper to prevent recurrence of Correction #9 |
...
| F2 | `APG-2580/sar-set-footgun-guardrails` | [followup-2](./APG-2580-followup-2-sar-set-footgun-guardrails.md) | Low | Architecture test that fails at build time if any SAR DTO field is `Set`/`MutableSet` (preventing recurrence of Correction #9). Optional Part B: sweep the mustache `.0` idiom in favour of a `{{#hasAny}}` helper. |
| F3 | `APG-2580/sar-fixture-drift-guardrail` | [followup-3](./APG-2580-followup-3-sar-fixture-drift-guardrail.md) | Low | CI gate that regens both SAR fixtures and fails on any diff. Would have caught Correction #9 automatically. |
